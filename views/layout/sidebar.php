...
<!-- formulario izquierdo -->
    <div class="bd-search text-center">
        <img src="/assets/img/moises2.jpg" class="rounded-circle" width="80" height="80" >
        <br>
        <span class="font-italic">Abraham Moises</span>
...
<nav class="collapse bd-links" id="bd-docs-nav">
    <div class="bd-toc-item active">
        <a class="bd-toc-link" href="/docs/4.1/getting-started/introduction/">
            <i class="fas fa-street-view"></i> Inicio Wolfstim
        </a>
        <ul class="nav bd-sidenav">
            <li class="bd-sidnav-active">
                <a href="/docs/4.1/getting-started/introduction/">Afiliacion</a>
            </li>
            <li>
